...
const ListSubject = () => {
    ...
    const getMajorIdBySubjectId = async (subjectId) => {
        const response = await instance.get(
            `/admin/subjects/${subjectId}/getMajorIdBySubjectId`
        );
    ...
    const onHandleUpdate = async (values) => {
        try {
            ...
            const response = await instance.put(
                ...
                { ...values, majors: values.majors.map((id) => ({ id })) }
            );
                                    ...
                                    subjects.map((subject) => (
                                        <div className="col" key={subject.id}>
                                            <div className="listCourse__item ">
                                                ...
                                                <div className=" teaching__card-bottom pb-3 border !mx-[-1px] ">
