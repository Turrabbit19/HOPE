...
export default function TeacherInfo() {
  ...
  useEffect(() => {
    ...
    const fetchTodayLessons = async () => {
      ...
      try {
        ...
        const todayLessons = data.data.flatMap((lesson) =>
  ...
  if (error)
    return (
      <div className="text-red-600 text-center p-2 text-lg">Lỗi: {error}</div>
    );
  if (!teacher)
    return (
      ...
      <div className="bg-white shadow rounded-lg p-6 mb-6">
        ...
        {activeTab === "timetable" && (
          <div>
            ...
            {console.log(
              "Đang render lịch học, số lượng bài học:",
              todayLessons.length
            )}
            {todayLessons.length > 0 ? (
                  ...
                  <div key={index} className="bg-gray-50 rounded-lg p-4 shadow">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                      ...
                      <p className="flex items-center">
                        ...
                        Thời gian: {formatTime(lesson.start_time)} -{" "}
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-500">
                  Bạn không có buổi dạy nào được lên lịch cho ngày hôm nay.
                </p>
              </div>
            )}
          </div>
