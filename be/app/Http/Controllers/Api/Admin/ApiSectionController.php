...
class ApiSectionController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        $validator = Validator::make($request->all(), [
            ...
            'name.sometimes' => 'Trường tên không bắt buộc nhưng nếu gửi lên, phải hợp lệ.',
            'name.string' => 'Tên phải là chuỗi ký tự.',
            'name.max' => 'Tên không được vượt quá 100 ký tự.',
            'name.unique' => 'Tên này đã tồn tại trong hệ thống.',
        ]);
    ...
    public function addNotification(Request $request, string $id)
    {
        $validator = Validator::make($request->all(), [
            ...
            'name.unique' => 'Tên thông báo đã tồn tại trong hệ thống.',
            ...
            'courses.*.id.required' => 'Mã khóa học là bắt buộc.',
            'courses.*.id.exists' => 'Khóa học không tồn tại trong hệ thống.',
        ]);
