...
const AsideClient = () => {
    ...
    return (
        <aside className="bg-gradient-to-br from-teal-50 to-blue-50 shadow-lg  p-6 border-r border-black transition-all duration-300 ease-in-out hover:shadow-xl">
            {/* Logo */}
...
const NavLink = ({ to, icon, children, color, activeLink, setActiveLink }) => {
    ...
    return (
        <Link
            to={to}
            onClick={handleClick}
            className={`flex items-center p-2 text-gray-700 rounded-lg transition-all duration-200 ease-in-out ${
                isActive
        ...
        >
            <span
                className={`p-2 rounded-md bg-white shadow-sm transition-all duration-200 ease-in-out mr-3 ${
                    isActive ? "bg-gray-300 shadow-md" : "group-hover:shadow-md"
                }`}
            >
                <svg
