...
const ListSections = () => {
        ...
        const fetchCourses = async () => {
            try {
                ...
                if (response.data && response.data.data) {
                    ...
                    notification.error({
                        message: "Lỗi",
                        description: "Không tìm thấy dữ liệu khóa học!",
                        duration: 3,
                    });
                }
            } catch (error) {
                ...
                notification.error({
                    message: "Lỗi",
                    description: "Lỗi khi lấy danh sách khóa học từ API.",
                    duration: 3,
                });
            }
        };
    ...
    const fetchSections = useCallback(async () => {
        try {
            ...
            notification.error({
                message: "Lỗi",
                description: "Không thể tải danh mục, vui lòng thử lại!",
                duration: 3,
            });
        }
    }, []);
    ...
    const handleAddNotification = useCallback(async () => {
        try {
            ...
            notification.error({
                message: "Lỗi",
                description: "Không thể thêm thông báo, vui lòng thử lại!",
                duration: 3,
            });
        }
                    ...
                    <div className="p-6 bg-white shadow-md rounded-lg">
                        ...
                        <div className="flex justify-between items-center mt-6">
                            ...
                            <span className="font-bold text-[14px] text-[#000]">
                                {filteredSections.length} danh mục
                            </span>
                        </div>
                    </div>
                    <div className="row row-cols-2 g-3">
                        ...
                        notifications.map((notificationItem) => (
                            ...
                            >
                                ...
                                <div className="text-2xl text-gray-700 mb-4 leading-relaxed">
                                    ...
                                    <p
                                        ...
                                        dangerouslySetInnerHTML={{
                                            __html: notificationItem.description,
                                        }}
                                    ></p>

                                    {/* Nút "Xem thêm" */}
                                    {notificationItem.description.length >
                                        100 && (
                                        <button
                                ...
                                <div className="mt-4 text-2xl text-gray-700 mb-4">
                                    ...
                                    {notificationItem.courses &&
                                    notificationItem.courses.length > 0 ? (
                                        <ul className="list-disc list-inside text-gray-600 mt-2">
                                            {notificationItem.courses.map(
                                                (course) => (
                                                    <li key={course.id}>
                                                        {course.name}
                                                    </li>
