...
const StudentManager = () => {
  ...
  let dataSearch = data.filter((e) => {
    ...
    return (
      fullname.search(textSearch) > -1 || student_code.search(textSearch) > -1
    );
  });
        ...
        <div className="flex justify-between mb-2">
          ...
          <div className="flex flex-row items-center">
            ...
            <input
              ...
              style={{ display: "none" }}
            />
            <Button onClick={handlePickExcel} className="ml-5" type="primary">
              Import
            </Button>
            <Button onClick={downloadExcel} className="ml-5" type="default">
              Export
            </Button>
          </div>
        </div>
