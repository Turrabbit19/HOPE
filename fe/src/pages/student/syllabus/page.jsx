          ...
          <div className="bg-blue-50 p-6 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-2xl">
              <p className="flex items-center">
                ...
                <strong>Số tín chỉ:</strong> {subject.subject.credit}
              </p>
              <p className="flex items-center">
                <User className="w-5 h-5 mr-2 text-blue-500" />{" "}
                <strong>Hình thức học:</strong> {subject.subject.form}
              </p>
            </div>
            <p className="mt-4 text-2xl">
              <strong>Mô tả:</strong> {subject.subject.description}
            </p>
          </div>
                  ...
                  <div key={index} className="mb-6 bg-gray-50 p-4 rounded-lg">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-2xl">
                      <p className="flex items-center">
                        ...
                        <strong>Lớp học: </strong> {subject.classroom.code}
                      </p>
                      <p className="flex items-center">
                        <Calendar className="w-5 h-5 mr-2 text-gray-600" />{" "}
                        <strong>Thời gian:</strong> {schedule.start_date} -{" "}
                        {schedule.end_date}
                      </p>
                      <p className="flex items-center">
                        <Clock className="w-5 h-5 mr-2 text-gray-600" />{" "}
                        <strong>Ca học:</strong> {schedule.shift_name}
                      </p>
                      <p className="flex items-center">
                        <User className="w-5 h-5 mr-2 text-gray-600" />{" "}
                        <strong>Giảng viên:</strong> {schedule.teacher_name}
                      </p>
                      <p className="flex items-center">
                  ...
                  {subject.schedule[0].lessons.map((lesson, index) => (
                    ...
                    >
                      <div className="flex justify-between items-center mb-2">
                        <strong className="text-2xl">{lesson.name}</strong>
...
export default function Syllabus() {
  ...
  return (
    <div className="mx-auto p-1 text-base">
      {/* Tab Navigation */}
        ...
        {curriculumData?.data.map((semester) => (
          ...
          >
            <div className="bg-blue-50 p-4 flex justify-between items-center">
              <h2 className="font-medium text-2xl">Học kỳ {semester.order}</h2>
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                <thead className="bg-gray-100 text-sm font-semibold">
                  <tr>
                    <th className="border py-1 px-2 text-left text-xl">STT</th>
