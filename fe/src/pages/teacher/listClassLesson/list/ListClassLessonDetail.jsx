    ...
    const submitAttendance = async (lessonId) => {
        ...
        try {
            ...
            if (response.status === 400) {
                throw new Error(
                    "Chỉ có thể điểm danh trong 15 phút đầu buổi học."
                );
            }
    ...
    return (
        <div className="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen p-8">
                ...
                <div className="p-8">
                    <div className="flex items-center mb-8 flex-col">
                        ...
                        <p className="text-xl text-gray-700 mb-8 flex items-center">
                            ...
                            <span className="ml-2">
                                {ScheduleInfor.start_date} -{" "}
                                {ScheduleInfor.end_date}
                            </span>
                        </p>
                    </div>
            ...
            {isModalOpen && (
                ...
                >
                    <div className="bg-white rounded-lg p-8 max-w-7xl w-full shadow-2xl transform transition-all duration-300 ease-in-out">
                        ...
                        {loading ? (
                            ...
                            <>
                                {/* Thay đổi phần này: bỏ phân trang, đổ hết sinh viên ra */}
                                <div className="overflow-x-auto max-h-[70vh] border border-gray-200 rounded-lg">
                                    <table className="min-w-full bg-white overflow-hidden">
                                        ...
                                        <tbody className="divide-y divide-gray-200">
                                            {/* Hiển thị toàn bộ students mà không chia trang */}
                                            {students.map((student) => (
                                                ...
                                                >
                                                    ...
                                                    <td className="py-4 px-6 whitespace-nowrap">
                                                        ...
                                                        ScheduleInfor.schedule_lessons.find(
                                                            (lesson) =>
                                                                lesson.id ===
                                                                selectedLesson
                                                        )?.status ===
                            ...
                            <div className="text-center py-8">
                                ...
                                <p className="text-gray-500">
                                    Lớp học này hiện chưa có sinh viên nào được
                                    thêm vào.
                                </p>
                            </div>
                        )}
                        ...
                        {!isAttendanceSubmitted &&
                            ...
                            ScheduleInfor.schedule_lessons.find(
                                ...
                                <button
                                    onClick={() =>
                                        submitAttendance(selectedLesson)
                                    }
