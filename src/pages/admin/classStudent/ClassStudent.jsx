    ...
    <div className="p-4">
      <div className="flex justify-between">
        <div className="flex gap-3 w-52">
          <div className="text-title text-lg font-medium">Quản Lý Lớp Học</div>
      ...
      <div className="flex justify-between items-center mt-4">
        ...
        <div className="text-sm font-semibold">3 lớp học</div>
      </div>
            ...
            <Col span={12}>
              ...
              <div className="mt-2">
                <div>
                  ...
                  <span className="font-semibold">THBTK112</span>
                </div>
                <div className="mt-2">
                  <span className="text-grey">Tên Môn: </span>{" "}
                  <span className="font-semibold">Tìm Hiểu Bản Thân</span>
                </div>
                <div className="mt-2">
                  <span className="text-grey">Mã Môn: </span>{" "}
                  <span className="font-semibold">PDP001</span>
                </div>
              </div>
            </Col>
            <Col span={12}>
