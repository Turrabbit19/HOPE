...
const Teach = () => {
  ...
  return (
    <div className="row row-cols-2 g-3">
                  ...
                  <div className="teaching__card-body">
                    <div className="mt-6 flex flex-col gap-8 pb-6">
                      <div className="flex gap-6">
                        <p className="text-[#9E9E9E]">Mã ngành:</p>
      ...
      <Modal
        title={editingMajor ? "Sửa Thông Tin Ngành" : "Thêm Mới Ngành"}
            ...
            <div style={{ flex: 1 }}>
              <Form.Item
                ...
                rules={[
                  ...
                  {
                    min: 4,
                    message: "Mã ngành phải có ít nhất 4 ký tự",
                  },
                ]}
              >
              ...
              <Form.Item
                ...
                rules={[
                  ...
                  {
                    min: 6,
                    message: "Tên ngành phải có ít nhất 6 ký tự",
                  },
                ]}
              >
