  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen p-8">
      <div className="w-full bg-white shadow-xl rounded-lg overflow-hidden">
        <div className="p-8">
          <div className="flex text-left mb-8 flex-col">
            <h2 className="text-4xl font-bold mb-6 text-gray-800 border-b pb-4">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-indigo-600">
                {ScheduleInfor.subject_name}
              </span>
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-7 justify-center items-center">
            ...
            <p className="text-2xl text-gray-700 mb-8 flex items-center">
