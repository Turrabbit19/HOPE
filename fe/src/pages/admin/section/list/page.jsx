    ...
    const fetchCourses = async () => {
      try {
        ...
        if (response.data && response.data.data) {
          setCourses(response.data.data); // Giả sử API trả về key `data`
        } else {
          message.error("Không tìm thấy dữ liệu khóa học!");
        }
      } catch (error) {
        console.error("Error fetching courses:", error);
        message.error("Lỗi khi lấy danh sách khóa học từ API.");
      }
    };
        ...
        <div className="col-12">
          ...
          <div className="row row-cols-2 g-3">
            {currentItems.length > 0 ? (
                ...
                <div className="col" key={section.id}>
                  <div className="teaching__card">
                    <div className="teaching__card-top">
                      ...
                      <Tooltip title="Thêm mới thông báo" className="mr-4">
                        <Button
                          icon={<PlusCircleOutlined />}
                          onClick={() => showAddNotificationModal(section)}
                        />
                      </Tooltip>
                    </div>
                    ...
                    <div className="teaching__card-bottom">
                      <button
                        ...
                        onClick={() => showNotifications(section)}
                      >
                        <BugOutlined />
                        Quản lý Thông Báo
                      </button>
              ...
              <div className="col-12">
                <div className="text-center">Không tìm thấy danh mục nào!</div>
              </div>
            )}
          </div>
        </div>
            ...
            notifications.map((notification) => (
              ...
              >
                ...
                <h2 className="text-3xl font-semibold text-gray-800 mb-4">
                  <span className="text-blue-600 mr-2">Tiêu đề:</span>
                  {notification.name}
                </h2>
      ...
      >
        <Form form={editForm} layout="vertical">
          ...
          >
            ...
            <Button type="primary" onClick={handleUpdateNotification}>
              Cập nhật
            </Button>
          </div>
        </Form>
