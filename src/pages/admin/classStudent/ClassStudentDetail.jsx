  ...
  return (
    <div className="pt-6 px-4">
      <div className="flex gap-3 w-52">
        <div className="text-title text-lg font-medium">Danh Sách Lịch Học</div>
      ...
      <div className="flex justify-between items-center mt-4">
        <Space>
          ...
          <Button
            onClick={() => {
              navigate(`/admin/class-student/${classId}/schedule/add-series`);
            }}
            style={{
              color: "#7017E2",
              borderColor: "#7017E2",
          ...
          <Button
            onClick={() => {
              navigate(`/admin/class-student/${classId}/schedule/add-manual`);
            }}
            style={{
              color: "#7017E2",
              borderColor: "#7017E2",
        ...
        >
          <div className="flex justify-between">
            <div className="flex justify-between gap-8">
              ...
              <Space>
                <span className="text-grey">Link Học Trực Tuyến: </span>{" "}
                <a
