...
const ClassRoom = () => {
    ...
    useEffect(() => {
        ...
        fetchClassrooms(pagination.current, searchTerm);
            ...
            <div className="col-12">
                ...
                >
                    <Form
                        ...
                        layout="vertical"
                        onFinish={
                            isEditModalVisible ? onHandleUpdate : onHandleSubmit
                        }
