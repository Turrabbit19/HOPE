...
export default function CourseRegistration() {
    ...
    const fetchSubjects = async () => {
        ...
        try {
            ...
            if (response.status === 403) {
                ...
                throw new Error(
                    errorData.error || "Thời gian đăng ký không hợp lệ."
                );
            }
    ...
    const confirmRegistration = async () => {
        ...
        try {
            ...
            if (!response.ok) {
                const errorData = await response.json();
                throw new Error(
                    errorData.message || "Không thể đăng ký khóa học"
                );
            }
    ...
    return (
        <div className="flex flex-col bg-gradient-to-br from-blue-100 h-[60vh] to-white w-full">
            <div className="flex flex-col flex-grow bg-gradient-to-br from-blue-100 to-white py-12 px-4 sm:px-6 lg:px-8">
